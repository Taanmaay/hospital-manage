...
<div class="col-sm-6" style="margin-left:20px">
    <h1>
    <span ><p align="left" style="padding-top:40px;font-size:33px;color:white;"> Tanmay Das </p></span>
    </h1>
    <h2>
    <span ><p align="left" style="padding-top:5px;font-size:27px;color:white;"> Electronics & Communication Engineering </p></span>
    </h2>
    <h3>
    <span ><p align="left" style="padding-top:5px;font-size:27px;color:white;"> HSTU </p></span>
    </h3>
    <h1>
    <span ><p align="left" style="font-size:25px;color:white;">Phone:01737-000000</p></span>
    </h1>
...
<div class="col-sm-5">
  <img src="image/new.jpg"  alt="my-image"align="right" style="margin-top:50px;height:300px;width:250px;">
    ...
    <div class="row">
    	<div class="col-sm-12">
        	<div class="footer bg-#990000">
            	<div class="copyright">
                	<p align="center"style="color:white; padding-top:100px;" >Copyright &copy;&nbsp;&nbsp;<span>tanmayhstu103@gmail.com</span></p>
                </div>
            </div>
        </div>
    </div>
